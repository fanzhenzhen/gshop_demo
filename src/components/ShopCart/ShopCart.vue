<template>
  <div>
      ...
      <transition name="move">
        <div class="shopcart-list" v-show="isShowCartShop" >
          ...
          <div class="list-content">
            <ul>
              <li class="food" v-for="(food, index) in shopCarts" :key="index">
    ...
    <div class="list-mask" v-show="isShowCartShop" @click="isShowCartShop = false"></div>
  </div>
</template>
...
import {CLEAR_CARTSHOPS} from '../../store/mutation_type'
