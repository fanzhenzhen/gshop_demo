<template>
  <div id="goodContainer">
    <div class="leftcontainer">
      <ul class="nav-list" ref="leftUl">
        <li class="nav-item" @click="leftNavIndex(index)" :class="{active:navIndex === index}" v-for="(good,index) in goods" :key="index"><p>{{good.name}}</p></li>
      </ul>
    </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods:{
      _initScroll(){
        this.leftScroll = new BetterScroll('.leftcontainer',{
          scrollY: true, // 设置纵向滑动
          click:true
        }),
